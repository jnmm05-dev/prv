...
RUN apt-get update -qqy \
  && apt-get -qqy install -y python3 python3-pip wget fonts-liberation libappindicator3-1 libasound2 tor libatk-bridge2.0-0 libnspr4 libnss3 lsb-release xdg-utils libxss1 libdbus-glib-1-2 libgbm1 \
